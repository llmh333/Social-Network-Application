...
public class AuthController {
  ...
  private final com.example.projectbase.service.impl.FirebaseAuthService firebaseAuthService;
  ...
  public ResponseEntity<?> firebaseLogin(
      @Valid @RequestBody com.example.projectbase.domain.dto.request.FirebaseLoginRequest request,
