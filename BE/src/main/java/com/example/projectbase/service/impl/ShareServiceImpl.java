        ...
        public SharePostResponseDto sharePost(Long postId, SharePostRequestDto request) {
                ...
                Post originalPost = postRepository.findById(postId)
                                .orElseThrow(() -> new NotFoundException(
                                                ErrorMessage.Post.ERR_NOT_FOUND_ORIGINAL_POST));
                ...
                postSummaryDto.setCreatedBy(originalPost.getUser().getId());
                postSummaryDto.setMediaList(originalPost.getMediaList().stream().map(mediaMapper::toMediaResponseDto)
